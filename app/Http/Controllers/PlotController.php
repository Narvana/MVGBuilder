            ...
            else
            {
                ...
                if($status === 'BOOKED')
                {
                    ...
                    if(!$CheckIncome)
                    {
                        ...
                        while ($Level) {
                            $total_income = ($incomePercentages["{$index}"] / 100) * $total_amount;
                            ...
                            if ($agentExist) {
                                ...
                                $totalIncome = array_sum($selectedPercentages);
                                
                                $mvgCommision= 17 - $totalIncome;
                                
                                $total_income = ($mvgCommision / 100) * $total_amount;
